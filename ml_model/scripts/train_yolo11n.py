#!/usr/bin/env python3
"""Train YOLOv11n on the Fridgify dataset."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Train YOLOv11n model for Fridgify object detection."
    )
    ...
    parser.add_argument("--name", default="fridgify_y11n_v4", help="Run name.")
